...
namespace Fashion.ERP.Mapping.Almoxarifado
{
    public class MaterialMap : FashionClassMap<Material>
    {
            ...
            : base("material", 100)
        {
            ...
            Map(x => x.Ncm).Length(8).Not.Nullable();
            ...
            References(x => x.Foto).Nullable().Cascade.All().Fetch.Join().LazyLoad(Laziness.False);
            ...
            References(x => x.Familia).Not.Nullable();
            References(x => x.GeneroFiscal).Not.Nullable();
