    ...
    public class Migration201605131717 : Migration
    {
        public override void Up()
        {
            ...
            Create.Table("producaoitem")
                ...
                .WithColumn("producaoitemmatrizcorte_id").AsInt64()
                .ForeignKey("FK_producaoitem_producaoitemmatrizcorte", "producaomatrizcorte", "id");
            ...
            Create.Table("producaoitemmaterial")
                ...
                .WithColumn("responsavel_id").AsInt64()
                ...
                .WithColumn("producaoitemmaterial_id").AsInt64()
            ...
            Create.Table("producao")
                ...
                .ForeignKey("FK_producao_producaoitem", "producaoitem", "id")
                .WithColumn("producaoprogramacao_id").AsInt64()
