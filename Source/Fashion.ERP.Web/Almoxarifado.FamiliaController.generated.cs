...
{
    public partial class FamiliaController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected FamiliaController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FamiliaController Actions { get { return MVC.Almoxarifado.Familia; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Almoxarifado";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Familia";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Familia";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Almoxarifado/Views/Familia/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Almoxarifado/Views/Familia/Editar.cshtml";
            public readonly string Index = "~/Areas/Almoxarifado/Views/Familia/Index.cshtml";
            public readonly string Novo = "~/Areas/Almoxarifado/Views/Familia/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FamiliaController : Fashion.ERP.Web.Areas.Almoxarifado.Controllers.FamiliaController
    {
        public T4MVC_FamiliaController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.FamiliaModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Almoxarifado.Models.FamiliaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.FamiliaModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Almoxarifado.Models.FamiliaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
