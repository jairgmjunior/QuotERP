...
namespace Fashion.ERP.Web.Areas.Comum.Controllers
{
    public partial class EmpresaController
    {
        ...
        protected EmpresaController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EmpresaController Actions { get { return MVC.Comum.Empresa; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Empresa";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Empresa";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Empresa/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Empresa/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Empresa/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Empresa/Novo.cshtml";
            public readonly string Pesquisar = "~/Areas/Comum/Views/Empresa/Pesquisar.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EmpresaController : Fashion.ERP.Web.Areas.Comum.Controllers.EmpresaController
    {
        public T4MVC_EmpresaController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.NovoEmpresaModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.NovoEmpresaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.EmpresaModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.EmpresaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void PesquisarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Models.PesquisarModel model);

        public override System.Web.Mvc.ActionResult Pesquisar(Fashion.ERP.Web.Models.PesquisarModel model)
        {
