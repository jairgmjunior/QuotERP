...
namespace Fashion.ERP.Web.Areas.EngenhariaProduto.Controllers
{
    public partial class GradeController
    {
        ...
        protected GradeController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public GradeController Actions { get { return MVC.EngenhariaProduto.Grade; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "EngenhariaProduto";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Grade";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Grade";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/EngenhariaProduto/Views/Grade/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/EngenhariaProduto/Views/Grade/Editar.cshtml";
            public readonly string Index = "~/Areas/EngenhariaProduto/Views/Grade/Index.cshtml";
            public readonly string Novo = "~/Areas/EngenhariaProduto/Views/Grade/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_GradeController : Fashion.ERP.Web.Areas.EngenhariaProduto.Controllers.GradeController
    {
        public T4MVC_GradeController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.GradeModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.GradeModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.GradeModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.GradeModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
