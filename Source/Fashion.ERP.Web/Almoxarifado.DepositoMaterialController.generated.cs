...
{
    public partial class DepositoMaterialController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected DepositoMaterialController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.JsonResult DepositosPorUnidade()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.DepositosPorUnidade);
        }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public DepositoMaterialController Actions { get { return MVC.Almoxarifado.DepositoMaterial; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Almoxarifado";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "DepositoMaterial";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "DepositoMaterial";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string DepositosPorUnidade = "DepositosPorUnidade";
        }
        ...
        public class ActionNameConstants
        {
            ...
            public const string DepositosPorUnidade = "DepositosPorUnidade";
        }
        ...
        static readonly ActionParamsClass_DepositosPorUnidade s_params_DepositosPorUnidade = new ActionParamsClass_DepositosPorUnidade();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_DepositosPorUnidade DepositosPorUnidadeParams { get { return s_params_DepositosPorUnidade; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_DepositosPorUnidade
        {
            public readonly string id = "id";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Almoxarifado/Views/DepositoMaterial/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Almoxarifado/Views/DepositoMaterial/Editar.cshtml";
            public readonly string Index = "~/Areas/Almoxarifado/Views/DepositoMaterial/Index.cshtml";
            public readonly string Novo = "~/Areas/Almoxarifado/Views/DepositoMaterial/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_DepositoMaterialController : Fashion.ERP.Web.Areas.Almoxarifado.Controllers.DepositoMaterialController
    {
        public T4MVC_DepositoMaterialController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.DepositoMaterialModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Almoxarifado.Models.DepositoMaterialModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.DepositoMaterialModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Almoxarifado.Models.DepositoMaterialModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void DepositosPorUnidadeOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, long id);

        public override System.Web.Mvc.JsonResult DepositosPorUnidade(long id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.DepositosPorUnidade);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            DepositosPorUnidadeOverride(callInfo, id);
            return callInfo;
        }
