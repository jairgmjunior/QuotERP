...
{
    public partial class MarcaController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected MarcaController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public MarcaController Actions { get { return MVC.Comum.Marca; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Marca";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Marca";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Marca/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Marca/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Marca/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Marca/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MarcaController : Fashion.ERP.Web.Areas.Comum.Controllers.MarcaController
    {
        public T4MVC_MarcaController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.MarcaModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.MarcaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.MarcaModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.MarcaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
