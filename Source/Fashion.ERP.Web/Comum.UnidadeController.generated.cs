...
namespace Fashion.ERP.Web.Areas.Comum.Controllers
{
    public partial class UnidadeController
    {
        ...
        protected UnidadeController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UnidadeController Actions { get { return MVC.Comum.Unidade; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Unidade";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Unidade";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string ObtenhaUnidadesDropDownList = "ObtenhaUnidadesDropDownList";
        }
        ...
        public class ActionNameConstants
        {
            ...
            public const string ObtenhaUnidadesDropDownList = "ObtenhaUnidadesDropDownList";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Unidade/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Unidade/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Unidade/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Unidade/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UnidadeController : Fashion.ERP.Web.Areas.Comum.Controllers.UnidadeController
    {
        public T4MVC_UnidadeController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.NovoUnidadeModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.NovoUnidadeModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.UnidadeModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.UnidadeModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ObtenhaUnidadesDropDownListOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        public override System.Web.Mvc.JsonResult ObtenhaUnidadesDropDownList()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.ObtenhaUnidadesDropDownList);
            ObtenhaUnidadesDropDownListOverride(callInfo);
            return callInfo;
        }
