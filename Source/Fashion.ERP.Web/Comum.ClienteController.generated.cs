...
namespace Fashion.ERP.Web.Areas.Comum.Controllers
{
    public partial class ClienteController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ClienteController Actions { get { return MVC.Comum.Cliente; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Cliente/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Cliente/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Cliente/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Cliente/Novo.cshtml";
            public readonly string Pesquisar = "~/Areas/Comum/Views/Cliente/Pesquisar.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ClienteController : Fashion.ERP.Web.Areas.Comum.Controllers.ClienteController
    {
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.NovoClienteModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.NovoClienteModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ClienteModel model, string filename);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.ClienteModel model, string filename)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "filename", filename);
            EditarOverride(callInfo, model, filename);
            return callInfo;
        }
