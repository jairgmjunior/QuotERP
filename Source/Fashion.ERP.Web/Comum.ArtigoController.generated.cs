...
namespace Fashion.ERP.Web.Areas.Comum.Controllers
{
    public partial class ArtigoController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ArtigoController Actions { get { return MVC.Comum.Artigo; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Artigo/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Artigo/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Artigo/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Artigo/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ArtigoController : Fashion.ERP.Web.Areas.Comum.Controllers.ArtigoController
    {
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ArtigoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.ArtigoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ArtigoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.ArtigoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
