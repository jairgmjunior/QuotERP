...
{
    public partial class ComprimentoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ComprimentoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ComprimentoController Actions { get { return MVC.EngenhariaProduto.Comprimento; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "EngenhariaProduto";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Comprimento";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Comprimento";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/EngenhariaProduto/Views/Comprimento/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/EngenhariaProduto/Views/Comprimento/Editar.cshtml";
            public readonly string Index = "~/Areas/EngenhariaProduto/Views/Comprimento/Index.cshtml";
            public readonly string Novo = "~/Areas/EngenhariaProduto/Views/Comprimento/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ComprimentoController : Fashion.ERP.Web.Areas.EngenhariaProduto.Controllers.ComprimentoController
    {
        public T4MVC_ComprimentoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ComprimentoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ComprimentoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ComprimentoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ComprimentoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
