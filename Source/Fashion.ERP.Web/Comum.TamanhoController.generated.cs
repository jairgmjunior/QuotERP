...
{
    public partial class TamanhoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected TamanhoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TamanhoController Actions { get { return MVC.Comum.Tamanho; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Tamanho";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Tamanho";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Tamanho/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Tamanho/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Tamanho/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Tamanho/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TamanhoController : Fashion.ERP.Web.Areas.Comum.Controllers.TamanhoController
    {
        public T4MVC_TamanhoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.TamanhoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.TamanhoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.TamanhoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.TamanhoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
