...
{
    public partial class CorController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected CorController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CorController Actions { get { return MVC.Comum.Cor; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Cor";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Cor";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Cor/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Cor/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Cor/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Cor/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CorController : Fashion.ERP.Web.Areas.Comum.Controllers.CorController
    {
        public T4MVC_CorController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.CorModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.CorModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.CorModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.CorModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
