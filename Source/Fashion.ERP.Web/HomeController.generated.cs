...
namespace Fashion.ERP.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Fashion.ERP.Web.Controllers.HomeController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Models.LoginModel model);

        public override System.Web.Mvc.ActionResult Login(Fashion.ERP.Web.Models.LoginModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
