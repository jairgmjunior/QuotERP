...
{
    public partial class DepartamentoProducaoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected DepartamentoProducaoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public DepartamentoProducaoController Actions { get { return MVC.Comum.DepartamentoProducao; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "DepartamentoProducao";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "DepartamentoProducao";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/DepartamentoProducao/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/DepartamentoProducao/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/DepartamentoProducao/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/DepartamentoProducao/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_DepartamentoProducaoController : Fashion.ERP.Web.Areas.Comum.Controllers.DepartamentoProducaoController
    {
        public T4MVC_DepartamentoProducaoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.DepartamentoProducaoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.DepartamentoProducaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.DepartamentoProducaoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.DepartamentoProducaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void GetDepartamentosOverride(T4MVC_System_Web_Mvc_JsonResult callInfo);

        public override System.Web.Mvc.JsonResult GetDepartamentos()
        {
