...
{
    public partial class PrazoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected PrazoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PrazoController Actions { get { return MVC.Comum.Prazo; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Prazo";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Prazo";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Prazo/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Prazo/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Prazo/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Prazo/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PrazoController : Fashion.ERP.Web.Areas.Comum.Controllers.PrazoController
    {
        public T4MVC_PrazoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.PrazoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.PrazoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.PrazoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.PrazoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
