...
{
    public partial class AreaInteresseController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AreaInteresseController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AreaInteresseController Actions { get { return MVC.Comum.AreaInteresse; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "AreaInteresse";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "AreaInteresse";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/AreaInteresse/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/AreaInteresse/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/AreaInteresse/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/AreaInteresse/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AreaInteresseController : Fashion.ERP.Web.Areas.Comum.Controllers.AreaInteresseController
    {
        public T4MVC_AreaInteresseController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.AreaInteresseModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.AreaInteresseModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.AreaInteresseModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.AreaInteresseModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
