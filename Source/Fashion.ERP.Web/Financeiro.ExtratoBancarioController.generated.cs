...
{
    public partial class ExtratoBancarioController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ExtratoBancarioController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ExtratoBancarioController Actions { get { return MVC.Financeiro.ExtratoBancario; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Financeiro";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ExtratoBancario";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ExtratoBancario";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Financeiro/Views/ExtratoBancario/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Financeiro/Views/ExtratoBancario/Editar.cshtml";
            public readonly string Index = "~/Areas/Financeiro/Views/ExtratoBancario/Index.cshtml";
            public readonly string Novo = "~/Areas/Financeiro/Views/ExtratoBancario/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ExtratoBancarioController : Fashion.ERP.Web.Areas.Financeiro.Controllers.ExtratoBancarioController
    {
        public T4MVC_ExtratoBancarioController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Financeiro.Models.ExtratoBancarioModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Financeiro.Models.ExtratoBancarioModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Financeiro.Models.ExtratoBancarioModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Financeiro.Models.ExtratoBancarioModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
