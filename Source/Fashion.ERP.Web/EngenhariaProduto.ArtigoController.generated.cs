...
{
    public partial class ArtigoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ArtigoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ArtigoController Actions { get { return MVC.EngenhariaProduto.Artigo; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "EngenhariaProduto";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Artigo";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Artigo";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/EngenhariaProduto/Views/Artigo/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/EngenhariaProduto/Views/Artigo/Editar.cshtml";
            public readonly string Index = "~/Areas/EngenhariaProduto/Views/Artigo/Index.cshtml";
            public readonly string Novo = "~/Areas/EngenhariaProduto/Views/Artigo/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ArtigoController : Fashion.ERP.Web.Areas.EngenhariaProduto.Controllers.ArtigoController
    {
        public T4MVC_ArtigoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ArtigoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ArtigoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ArtigoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ArtigoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
