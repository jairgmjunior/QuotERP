...
{
    public partial class MeioPagamentoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected MeioPagamentoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public MeioPagamentoController Actions { get { return MVC.Comum.MeioPagamento; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "MeioPagamento";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "MeioPagamento";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/MeioPagamento/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/MeioPagamento/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/MeioPagamento/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/MeioPagamento/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MeioPagamentoController : Fashion.ERP.Web.Areas.Comum.Controllers.MeioPagamentoController
    {
        public T4MVC_MeioPagamentoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.MeioPagamentoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.MeioPagamentoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.MeioPagamentoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.MeioPagamentoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
