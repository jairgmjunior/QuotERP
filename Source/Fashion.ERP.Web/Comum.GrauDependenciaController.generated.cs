...
{
    public partial class GrauDependenciaController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected GrauDependenciaController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public GrauDependenciaController Actions { get { return MVC.Comum.GrauDependencia; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "GrauDependencia";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "GrauDependencia";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/GrauDependencia/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/GrauDependencia/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/GrauDependencia/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/GrauDependencia/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_GrauDependenciaController : Fashion.ERP.Web.Areas.Comum.Controllers.GrauDependenciaController
    {
        public T4MVC_GrauDependenciaController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.GrauDependenciaModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.GrauDependenciaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.GrauDependenciaModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.GrauDependenciaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
