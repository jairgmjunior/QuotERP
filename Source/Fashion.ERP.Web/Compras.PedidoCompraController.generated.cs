...
namespace Fashion.ERP.Web.Areas.Compras.Controllers
{
    public partial class PedidoCompraController
    {
        ...
        protected PedidoCompraController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult PesquisarReferenciaExterna()
        {
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "PedidoCompra";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "PedidoCompra";
        ...
        static readonly ActionParamsClass_PesquisarReferenciaExterna s_params_PesquisarReferenciaExterna = new ActionParamsClass_PesquisarReferenciaExterna();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_PesquisarReferenciaExterna PesquisarReferenciaExternaParams { get { return s_params_PesquisarReferenciaExterna; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PedidoCompraController : Fashion.ERP.Web.Areas.Compras.Controllers.PedidoCompraController
    {
        public T4MVC_PedidoCompraController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Compras.Models.PedidoCompraModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Compras.Models.PedidoCompraModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void PesquisarReferenciaExternaOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string referenciaExterna);

        public override System.Web.Mvc.ActionResult PesquisarReferenciaExterna(string referenciaExterna)
        {
