...
namespace Fashion.ERP.Web.Areas.Comum.Controllers
{
    public partial class ProdutoBaseController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProdutoBaseController Actions { get { return MVC.Comum.ProdutoBase; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/ProdutoBase/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/ProdutoBase/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/ProdutoBase/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/ProdutoBase/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProdutoBaseController : Fashion.ERP.Web.Areas.Comum.Controllers.ProdutoBaseController
    {
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ProdutoBaseModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.ProdutoBaseModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ProdutoBaseModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.ProdutoBaseModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
