...
{
    public partial class ContaBancariaController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ContaBancariaController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ContaBancariaController Actions { get { return MVC.Financeiro.ContaBancaria; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Financeiro";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ContaBancaria";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ContaBancaria";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Financeiro/Views/ContaBancaria/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Financeiro/Views/ContaBancaria/Editar.cshtml";
            public readonly string Index = "~/Areas/Financeiro/Views/ContaBancaria/Index.cshtml";
            public readonly string Novo = "~/Areas/Financeiro/Views/ContaBancaria/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ContaBancariaController : Fashion.ERP.Web.Areas.Financeiro.Controllers.ContaBancariaController
    {
        public T4MVC_ContaBancariaController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Financeiro.Models.ContaBancariaModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Financeiro.Models.ContaBancariaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Financeiro.Models.ContaBancariaModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Financeiro.Models.ContaBancariaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
