...
{
    public partial class CentroCustoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected CentroCustoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CentroCustoController Actions { get { return MVC.Comum.CentroCusto; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "CentroCusto";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "CentroCusto";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/CentroCusto/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/CentroCusto/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/CentroCusto/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/CentroCusto/Novo.cshtml";
            public readonly string Pesquisar = "~/Areas/Comum/Views/CentroCusto/Pesquisar.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CentroCustoController : Fashion.ERP.Web.Areas.Comum.Controllers.CentroCustoController
    {
        public T4MVC_CentroCustoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.CentroCustoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.CentroCustoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.CentroCustoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.CentroCustoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
