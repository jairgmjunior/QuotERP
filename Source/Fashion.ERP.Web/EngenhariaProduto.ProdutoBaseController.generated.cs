...
{
    public partial class ProdutoBaseController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ProdutoBaseController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProdutoBaseController Actions { get { return MVC.EngenhariaProduto.ProdutoBase; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "EngenhariaProduto";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ProdutoBase";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ProdutoBase";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/EngenhariaProduto/Views/ProdutoBase/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/EngenhariaProduto/Views/ProdutoBase/Editar.cshtml";
            public readonly string Index = "~/Areas/EngenhariaProduto/Views/ProdutoBase/Index.cshtml";
            public readonly string Novo = "~/Areas/EngenhariaProduto/Views/ProdutoBase/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProdutoBaseController : Fashion.ERP.Web.Areas.EngenhariaProduto.Controllers.ProdutoBaseController
    {
        public T4MVC_ProdutoBaseController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ProdutoBaseModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ProdutoBaseModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ProdutoBaseModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ProdutoBaseModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
