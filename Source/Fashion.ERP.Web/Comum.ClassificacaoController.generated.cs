...
namespace Fashion.ERP.Web.Areas.Comum.Controllers
{
    public partial class ClassificacaoController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ClassificacaoController Actions { get { return MVC.Comum.Classificacao; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Classificacao/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Classificacao/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Classificacao/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Classificacao/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ClassificacaoController : Fashion.ERP.Web.Areas.Comum.Controllers.ClassificacaoController
    {
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ClassificacaoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.ClassificacaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ClassificacaoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.ClassificacaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
