...
{
    public partial class PrestadorServicoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected PrestadorServicoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public PrestadorServicoController Actions { get { return MVC.Comum.PrestadorServico; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "PrestadorServico";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "PrestadorServico";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/PrestadorServico/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/PrestadorServico/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/PrestadorServico/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/PrestadorServico/Novo.cshtml";
            public readonly string Pesquisar = "~/Areas/Comum/Views/PrestadorServico/Pesquisar.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PrestadorServicoController : Fashion.ERP.Web.Areas.Comum.Controllers.PrestadorServicoController
    {
        public T4MVC_PrestadorServicoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.NovoPrestadorServicoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.NovoPrestadorServicoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.PrestadorServicoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.PrestadorServicoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
