...
{
    public partial class SubcategoriaController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected SubcategoriaController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.JsonResult Subcategorias()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.Subcategorias);
        }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SubcategoriaController Actions { get { return MVC.Almoxarifado.Subcategoria; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Almoxarifado";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Subcategoria";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Subcategoria";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string Subcategorias = "Subcategorias";
        }
        ...
        static readonly ActionParamsClass_Subcategorias s_params_Subcategorias = new ActionParamsClass_Subcategorias();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_Subcategorias SubcategoriasParams { get { return s_params_Subcategorias; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_Subcategorias
        {
            public readonly string id = "id";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Almoxarifado/Views/Subcategoria/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Almoxarifado/Views/Subcategoria/Editar.cshtml";
            public readonly string Index = "~/Areas/Almoxarifado/Views/Subcategoria/Index.cshtml";
            public readonly string Novo = "~/Areas/Almoxarifado/Views/Subcategoria/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SubcategoriaController : Fashion.ERP.Web.Areas.Almoxarifado.Controllers.SubcategoriaController
    {
        public T4MVC_SubcategoriaController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.SubcategoriaModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Almoxarifado.Models.SubcategoriaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.SubcategoriaModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Almoxarifado.Models.SubcategoriaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void SubcategoriasOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, long id);

        public override System.Web.Mvc.JsonResult Subcategorias(long id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.Subcategorias);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            SubcategoriasOverride(callInfo, id);
            return callInfo;
        }
