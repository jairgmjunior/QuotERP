...
{
    public partial class ColecaoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ColecaoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ColecaoController Actions { get { return MVC.Comum.Colecao; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Colecao";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Colecao";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Colecao/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Colecao/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Colecao/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Colecao/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ColecaoController : Fashion.ERP.Web.Areas.Comum.Controllers.ColecaoController
    {
        public T4MVC_ColecaoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ColecaoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.ColecaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ColecaoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.ColecaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
