...
namespace Fashion.ERP.Web.Areas.EngenhariaProduto.Controllers
{
    public partial class ClassificacaoController
    {
        ...
        protected ClassificacaoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ClassificacaoController Actions { get { return MVC.EngenhariaProduto.Classificacao; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "EngenhariaProduto";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Classificacao";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Classificacao";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/EngenhariaProduto/Views/Classificacao/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/EngenhariaProduto/Views/Classificacao/Editar.cshtml";
            public readonly string Index = "~/Areas/EngenhariaProduto/Views/Classificacao/Index.cshtml";
            public readonly string Novo = "~/Areas/EngenhariaProduto/Views/Classificacao/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ClassificacaoController : Fashion.ERP.Web.Areas.EngenhariaProduto.Controllers.ClassificacaoController
    {
        public T4MVC_ClassificacaoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ClassificacaoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ClassificacaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ClassificacaoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.EngenhariaProduto.Models.ClassificacaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
