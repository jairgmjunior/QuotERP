...
{
    public partial class TipoFornecedorController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected TipoFornecedorController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TipoFornecedorController Actions { get { return MVC.Comum.TipoFornecedor; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "TipoFornecedor";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "TipoFornecedor";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/TipoFornecedor/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/TipoFornecedor/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/TipoFornecedor/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/TipoFornecedor/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TipoFornecedorController : Fashion.ERP.Web.Areas.Comum.Controllers.TipoFornecedorController
    {
        public T4MVC_TipoFornecedorController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.TipoFornecedorModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.TipoFornecedorModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.TipoFornecedorModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.TipoFornecedorModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
