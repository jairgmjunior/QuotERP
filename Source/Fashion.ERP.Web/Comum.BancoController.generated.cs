...
namespace Fashion.ERP.Web.Areas.Comum.Controllers
{
    public partial class BancoController
    {
        ...
        protected BancoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BancoController Actions { get { return MVC.Comum.Banco; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Banco";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Banco";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Pesquisar = "~/Areas/Comum/Views/Banco/Pesquisar.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BancoController : Fashion.ERP.Web.Areas.Comum.Controllers.BancoController
    {
        public T4MVC_BancoController() : base(Dummy.Instance) { }
        ...
        partial void PesquisarCodigoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int? codigo);

        public override System.Web.Mvc.ActionResult PesquisarCodigo(int? codigo)
        {
