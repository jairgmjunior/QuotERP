...
{
    public partial class UnidadeMedidaController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected UnidadeMedidaController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult ConsultaUnidadeMedida()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ConsultaUnidadeMedida);
        }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UnidadeMedidaController Actions { get { return MVC.Almoxarifado.UnidadeMedida; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Almoxarifado";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "UnidadeMedida";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "UnidadeMedida";
        ...
        static readonly ActionParamsClass_ConsultaUnidadeMedida s_params_ConsultaUnidadeMedida = new ActionParamsClass_ConsultaUnidadeMedida();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_ConsultaUnidadeMedida ConsultaUnidadeMedidaParams { get { return s_params_ConsultaUnidadeMedida; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_ConsultaUnidadeMedida
        {
            public readonly string id = "id";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Almoxarifado/Views/UnidadeMedida/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Almoxarifado/Views/UnidadeMedida/Editar.cshtml";
            public readonly string Index = "~/Areas/Almoxarifado/Views/UnidadeMedida/Index.cshtml";
            public readonly string Novo = "~/Areas/Almoxarifado/Views/UnidadeMedida/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UnidadeMedidaController : Fashion.ERP.Web.Areas.Almoxarifado.Controllers.UnidadeMedidaController
    {
        public T4MVC_UnidadeMedidaController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.UnidadeMedidaModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Almoxarifado.Models.UnidadeMedidaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.UnidadeMedidaModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Almoxarifado.Models.UnidadeMedidaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ConsultaUnidadeMedidaOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long? id);

        public override System.Web.Mvc.ActionResult ConsultaUnidadeMedida(long? id)
        {
