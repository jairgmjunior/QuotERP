...
namespace Fashion.ERP.Web.Areas.Comum.Controllers
{
    public partial class ComprimentoController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ComprimentoController Actions { get { return MVC.Comum.Comprimento; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/Comprimento/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/Comprimento/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/Comprimento/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/Comprimento/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ComprimentoController : Fashion.ERP.Web.Areas.Comum.Controllers.ComprimentoController
    {
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ComprimentoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.ComprimentoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ComprimentoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.ComprimentoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
