...
{
    public partial class RemessaProducaoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected RemessaProducaoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "RemessaProducao";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "RemessaProducao";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Producao/Views/RemessaProducao/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Producao/Views/RemessaProducao/Editar.cshtml";
            public readonly string Index = "~/Areas/Producao/Views/RemessaProducao/Index.cshtml";
            public readonly string Novo = "~/Areas/Producao/Views/RemessaProducao/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_RemessaProducaoController : Fashion.ERP.Web.Areas.Producao.Controllers.RemessaProducaoController
    {
        public T4MVC_RemessaProducaoController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Producao.Models.RemessaProducaoModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Producao.Models.RemessaProducaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Producao.Models.RemessaProducaoModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Producao.Models.RemessaProducaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Producao.Models.PesquisaRemessaProducaoModel model);

        public override System.Web.Mvc.ActionResult Index(Fashion.ERP.Web.Areas.Producao.Models.PesquisaRemessaProducaoModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ObtenhaListaGridModelOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Kendo.Mvc.UI.DataSourceRequest request, Fashion.ERP.Web.Areas.Producao.Models.PesquisaRemessaProducaoModel model);

        public override System.Web.Mvc.ActionResult ObtenhaListaGridModel(Kendo.Mvc.UI.DataSourceRequest request, Fashion.ERP.Web.Areas.Producao.Models.PesquisaRemessaProducaoModel model)
        {
