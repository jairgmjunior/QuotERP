...
{
    public partial class DespesaReceitaController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected DespesaReceitaController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public DespesaReceitaController Actions { get { return MVC.Financeiro.DespesaReceita; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Financeiro";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "DespesaReceita";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "DespesaReceita";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Financeiro/Views/DespesaReceita/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Financeiro/Views/DespesaReceita/Editar.cshtml";
            public readonly string Index = "~/Areas/Financeiro/Views/DespesaReceita/Index.cshtml";
            public readonly string Novo = "~/Areas/Financeiro/Views/DespesaReceita/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_DespesaReceitaController : Fashion.ERP.Web.Areas.Financeiro.Controllers.DespesaReceitaController
    {
        public T4MVC_DespesaReceitaController() : base(Dummy.Instance) { }
        ...
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Financeiro.Models.PesquisaDespesaReceitaModel model);

        public override System.Web.Mvc.ActionResult Index(Fashion.ERP.Web.Areas.Financeiro.Models.PesquisaDespesaReceitaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Financeiro.Models.DespesaReceitaModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Financeiro.Models.DespesaReceitaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Financeiro.Models.DespesaReceitaModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Financeiro.Models.DespesaReceitaModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
