...
{
    public partial class ClassificacaoDificuldadeController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ClassificacaoDificuldadeController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ClassificacaoDificuldadeController Actions { get { return MVC.Comum.ClassificacaoDificuldade; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Comum";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ClassificacaoDificuldade";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ClassificacaoDificuldade";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Comum/Views/ClassificacaoDificuldade/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Comum/Views/ClassificacaoDificuldade/Editar.cshtml";
            public readonly string Index = "~/Areas/Comum/Views/ClassificacaoDificuldade/Index.cshtml";
            public readonly string Novo = "~/Areas/Comum/Views/ClassificacaoDificuldade/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ClassificacaoDificuldadeController : Fashion.ERP.Web.Areas.Comum.Controllers.ClassificacaoDificuldadeController
    {
        public T4MVC_ClassificacaoDificuldadeController() : base(Dummy.Instance) { }
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ClassificacaoDificuldadeModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Comum.Models.ClassificacaoDificuldadeModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Comum.Models.ClassificacaoDificuldadeModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Comum.Models.ClassificacaoDificuldadeModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
