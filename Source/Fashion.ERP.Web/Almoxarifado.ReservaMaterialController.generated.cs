...
{
    public partial class ReservaMaterialController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ReservaMaterialController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ReservaMaterialController Actions { get { return MVC.Almoxarifado.ReservaMaterial; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Almoxarifado";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ReservaMaterial";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ReservaMaterial";
        ...
        public class ViewsClass
        {
            ...
            public readonly string _NovoOuEditar = "~/Areas/Almoxarifado/Views/ReservaMaterial/_NovoOuEditar.cshtml";
            public readonly string Editar = "~/Areas/Almoxarifado/Views/ReservaMaterial/Editar.cshtml";
            public readonly string Index = "~/Areas/Almoxarifado/Views/ReservaMaterial/Index.cshtml";
            public readonly string Novo = "~/Areas/Almoxarifado/Views/ReservaMaterial/Novo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ReservaMaterialController : Fashion.ERP.Web.Areas.Almoxarifado.Controllers.ReservaMaterialController
    {
        public T4MVC_ReservaMaterialController() : base(Dummy.Instance) { }
        ...
        partial void ObtenhaListaGridModelOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Kendo.Mvc.UI.DataSourceRequest request, Fashion.ERP.Web.Areas.Almoxarifado.Models.PesquisaReservaMaterialModel model);

        public override System.Web.Mvc.ActionResult ObtenhaListaGridModel(Kendo.Mvc.UI.DataSourceRequest request, Fashion.ERP.Web.Areas.Almoxarifado.Models.PesquisaReservaMaterialModel model)
        {
        ...
        partial void NovoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.ReservaMaterialModel model);

        public override System.Web.Mvc.ActionResult Novo(Fashion.ERP.Web.Areas.Almoxarifado.Models.ReservaMaterialModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Novo);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void EditarOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Fashion.ERP.Web.Areas.Almoxarifado.Models.ReservaMaterialModel model);

        public override System.Web.Mvc.ActionResult Editar(Fashion.ERP.Web.Areas.Almoxarifado.Models.ReservaMaterialModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Editar);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
